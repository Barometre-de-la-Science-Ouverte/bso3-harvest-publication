...
class UpdateDatabase(TestCase):
    ...
    def test_given_3_local_doi_uuid_when_call_update_database_and_all_in_swift_storage_then_calls_of_every_functions_with_expected_nb_calls(
        ...
        mock_get_lmdb_content_pickle.return_value = {
            'uuid_1':{'harvester_used': 'fake_harvester_used_1', 'domain': 'fake_domain_1', 'url_used': 'fake_url_used_1'},
            'uuid_2':{'harvester_used': 'fake_harvester_used_2', 'domain': 'fake_domain_2', 'url_used': 'fake_url_used_2'},
            'uuid_3':{'harvester_used': 'fake_harvester_used_3', 'domain': 'fake_domain_3', 'url_used': 'fake_url_used_3'}
        }
        mock_get_lmdb_content_str.return_value = [
            (0, 'uuid_1', 5),
            (0, 'uuid_2', 5),
