...
files_to_upload = [
    ('./tmp/downloaded_publications/9fea8e3a-344c-4552-874c-6852074bcdd1.json',
     os.path.join('processed','9f', 'ea', '8e', '3a', '9fea8e3a-344c-4552-874c-6852074bcdd1', '9fea8e3a-344c-4552-874c-6852074bcdd1.json')),
    ('./tmp/downloaded_publications/dcd41f3e-4dcb-41b4-8d60-bc8abce3ee38.json',
     os.path.join('processed', 'dc', 'd4', '1f', '3e', 'dcd41f3e-4dcb-41b4-8d60-bc8abce3ee38', 'dcd41f3e-4dcb-41b4-8d60-bc8abce3ee38.json')),
]